<input type="hidden" id="hiddenExamNo" value="exam_3"></input>
...
-->
            ...
            <div class="card-body">
                <div class="col-12">
                    <h2 class="h2 text-primary ">คลิกปุ่มแล้ว Alert ข้อความ "HelloWorld"</h2>
                </div>

                <div class="col-12 pt-10">
                    <button class="btn btn-secondary" onclick=sayHello()>Say Hello</button>
                </div>
    ...
    <div class="card card-custom bg-primary">
                ...
                <div class="col-12">
                    ...
                    <xmp><button class="btn btn-secondary" onclick=sayHello()>Say Hello</button></xmp>
                </div>
            </div>
            <!--end::Body-->
        </div>
