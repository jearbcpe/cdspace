<input type="hidden" id="hiddenExamNo" value="exam_6"></input>
...
-->
            ...
            <div class="card-body">
                <div class="col-12">
                    <h2 class="h2 text-primary ">คลิกปุ่มแล้วพิมพ์หน้าจอออกทางเครื่อง Printer</h2>
                </div>

                <div class="col-12 pt-10">
                    <button class="btn btn-secondary" onclick=printPage()>Print Page</button>
                </div>
