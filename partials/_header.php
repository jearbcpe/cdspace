								...
								<div class="header-menu-wrapper header-menu-wrapper-left py-lg-2" id="kt_header_menu_wrapper">
									...
									<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
										...
										<ul class="menu-nav">
											...
											<li class="menu-item menu-item-submenu <?=($arrPage[0]=="javascript") ?  'menu-item-active' :  ''; ?> " data-menu-toggle="click" aria-haspopup="true">
												...
												<div class="menu-submenu menu-submenu-classic menu-submenu-left">
													...
													<li class="menu-item" aria-haspopup="true">
														...
														<li class="menu-item" aria-haspopup="true">
															<a target="_blank" href="https://preview.keenthemes.com/metronic/demo6/builder.html" class="menu-link">
																<span class="svg-icon menu-icon">
											...
											<li class="menu-item menu-item-submenu <?=($arrPage[0]=="features") ?  'menu-item-active' :  ''; ?>" data-menu-toggle="click" aria-haspopup="true">
												<a href="javascript:;" class="menu-link menu-toggle">
											...
											<li class="menu-item menu-item-submenu <?=($arrPage[0]=="workshop") ?  'menu-item-active' :  ''; ?>" data-menu-toggle="click" aria-haspopup="true">
												<a href="javascript:;" class="menu-link menu-toggle">
